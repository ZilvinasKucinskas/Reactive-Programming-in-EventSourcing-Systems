...
Šis validatorius filtruoja tik tas užklausos, kur parametras id yra perduodamas kaip sveikasis skaičius. Jei jis toks nėra, užklausa net nepasiekia kontrolieriaus.
...
\begin{lstlisting}[]
  get    'sample/search' => 'search#best_match',  constraints: BestMatchConstraint
  get    'sample/search' => 'search#trending',    constraints: TrendingSearchConstraint
  get    'sample/search' => 'search#new',         constraints: NewSearchConstraint
...
Jeigu užklausos parametras \lstinline|format| nebuvo nurodytas, numatytatasis parametras \lstinline|params[:format] = `jpg'| bus perduotas.
